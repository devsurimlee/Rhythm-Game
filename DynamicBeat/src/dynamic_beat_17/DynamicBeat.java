...
public class DynamicBeat extends JPanel /*JFrame*/ {
	...
	//하나의 게임이라는 것은 하나의 프로그램이 실행되었을때 단 하나의 게임만 진행 가능, 즉 동시에 여러 게임을 실행 시킬 수 없기때문에, 프로그램 전체에서 통용이 가능하다.
	...
	public DynamicBeat() /* 생성자 */ {
		//순서에 맞게 넣어줌으로써 변수를 순식간에 초기화, 초기화 된 변수를 트랙리스트에 넣어줌으로써 곡들의 리스트를 관리할 수 있게 됨
				...
				trackList.add(new Track("Energy Title Image.png", "Ask The Wind Start.jpg", 
						"Energy Game Image.jpg", "Miya - Ask the wind.mp3", "Miya - Ask the wind.mp3", "Miya - Ask The Wind"));
